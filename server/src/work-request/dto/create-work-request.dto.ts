...
export class CreateWorkRequestDto {
  ...
  @ApiProperty({ example: '2024-10-07T10:00:00.000Z', description: 'Дата и время начала работы' })
  readonly startDate: Date;

  @ApiProperty({ example: '2024-10-07T11:00:00.000Z', description: 'Дата и время окончания работы' })
